...
/***
  ftimage.h was taken from the FreeType library, version 2.1.3, just like
  ftgrays.h and ftgrays.c. The only thing I changed was moving
  FT_BEGIN_HEADER and FT_END_HEADER in #ifndef _STANDALONE_ blocks.
  _STANDALONE_ needs to be defined or you'll have to use the whole of the
  FreeType library.
***/
