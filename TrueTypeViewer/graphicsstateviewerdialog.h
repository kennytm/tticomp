...
#ifndef GRAPHICSSTATEVIEWERDIALOG_H
#define GRAPHICSSTATEVIEWERDIALOG_H
...
class GraphicsStateViewerDialog : public CVTViewerDialogBase {
	Q_OBJECT

public:
	GraphicsStateViewerDialog(QWidget* parent);
	~GraphicsStateViewerDialog();

public slots:
	virtual void setGraphicsState (const GlyphProcessor::GraphicsState & state);
};

#endif //GRAPHICSSTATEVIEWERDIALOG_H
