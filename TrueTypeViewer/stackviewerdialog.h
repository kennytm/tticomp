...
#ifndef STACKVIEWERDIALOG_H
#define STACKVIEWERDIALOG_H
...
class StackViewerDialog : public StackViewerDialogBase {
	Q_OBJECT

public:
	StackViewerDialog(QWidget* parent);
	~StackViewerDialog();

public slots:
	virtual void setStack (const std::vector <Long> & stack);
};

#endif //STACKVIEWERDIALOG_H
