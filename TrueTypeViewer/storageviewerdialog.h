...
#ifndef STORAGEVIEWERDIALOG_H
#define STORAGEVIEWERDIALOG_H
...
#include "stackviewerdialogbase.h"

class StorageViewerDialog : public StackViewerDialogBase {
	Q_OBJECT

public:
	StorageViewerDialog(QWidget* parent);
	~StorageViewerDialog();

public slots:
	virtual void setStorage (const GlyphProcessor::Storage & storage);
};

#endif //STORAGEVIEWERDIALOG_H
